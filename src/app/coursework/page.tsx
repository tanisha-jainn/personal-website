  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div style={{ marginLeft: '20%', marginRight: '20%' }}>
            <h1 style={{ fontSize: '24px', fontWeight: 'bold', fontFamily: 'Sabon', color: '#333', paddingBottom: 13 }}>
            ...
            <li style={{ fontSize: '16px', fontFamily: 'Sabon', paddingBottom: 5, listStyleType: 'none', paddingLeft: '16px' }}>
            ...
            <li style={{ fontSize: '16px', fontFamily: 'Sabon', paddingBottom: 18 }}>
